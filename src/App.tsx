...
import { Heart, MapPin, Play, Sparkles, Menu, X } from 'lucide-react';
    ...
    <section className="relative w-full min-h-screen sm:h-screen overflow-hidden">
      ...
      <nav className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between px-4 sm:px-6 md:px-10 py-4 sm:py-6">
        ...
        <div className="flex items-center gap-3 sm:gap-6 text-[#2d3a2a]">
          <a href="#memories" className="hidden sm:flex items-center gap-2 text-sm font-medium hover:opacity-80 transition-opacity">
            <Heart className="w-4 h-4" />
            Наши планы
          </a>
          <a href="#map" className="hidden sm:flex items-center gap-2 text-sm font-medium hover:opacity-80 transition-opacity">
      ...
      >
        <div className="flex flex-col h-full pt-24 px-8 pb-8">
          ...
          >
            <a href="#memories" className="flex items-center gap-2 text-sm font-medium text-[#2d3a2a] sm:hidden">
              <Heart className="w-4 h-4" />
              Наши планы
            </a>
            <a href="#map" className="flex items-center gap-2 text-sm font-medium text-[#2d3a2a] sm:hidden">
              <MapPin className="w-4 h-4" />
              Карта
            </a>
