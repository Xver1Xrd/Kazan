...
export const SECRET_LETTER = {
  title: 'Ты справилась ♥',
  paragraphs: [
    'Если ты это читаешь — значит, ты разгадала все четыре шифра. Я в тебе не сомневался.',
    ...
    'Спасибо, что ты у меня есть. Дальше — больше путешествий, больше закатов и больше нас.',
  ],
