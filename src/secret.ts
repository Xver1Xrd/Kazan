...
export const SECRET_LETTER = {
  title: 'Ты справилась ♥',
  paragraphs: [
    'Если ты это читаешь — значит, ты разгадала все четыре шифра. Я в тебе не сомневался. Я безумно благодарен тебе, что ты выделила на это время и свои силы, ты большая молодец и модадешечка',
    'Этот сайт я собирал про нашу поездку, но эта страница — не про Казань. Она про то, что с тобой мне интересно везде: хоть в самолёте, хоть на Баумана, хоть дома на диване.',
    'Безумно сильно люблю тебя, ты моя единственная, самая самая и просто идеальная 💋',
  ],
  signature: 'От твоего самого любимого',
};
