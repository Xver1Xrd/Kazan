...
export default function MemoriesSection() {
  return (
    <section id="memories" className="relative scroll-mt-20 px-4 sm:px-6 md:px-10 py-20 sm:py-28 bg-[#1f2a1d] dark:bg-[#0a120d] text-white">
        ...
        <ul className="mt-12 flex flex-col gap-5 text-left max-w-xl mx-auto">
          {PLANS.map((plan, i) => (
            <Reveal key={plan} delay={i * 0.07}>
              <li className="flex items-start gap-3 bg-white/5 rounded-xl px-5 py-4">
